...
export function CriticalApprovalQueue() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: (updated) => {
      ...
      toast({ title: `Case ${updated.reference_no} approved — Module Lead can now close it`, variant: 'success' })
      ...
      <div className="space-y-3">
        ...
        {pendingApproval.length === 0 ? (
          <EmptyState
            ...
            description="When an engineer resolves a critical-priority case, it will appear here for your approval before the Module Lead can close it."
          />
        ) : (
          <div className="space-y-3">
              ...
              return (
                <div key={c.id} className="rounded-xl border border-red-200 dark:border-red-800 bg-card p-4 space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground bg-red-50/40 dark:bg-red-950/20 rounded-lg px-3 py-2 border border-red-100 dark:border-red-900/40">
                    Critical case — your approval is required before the Module Lead can close this case.
                  </p>
                  {fb && (
          ...
          {approvingCase && (
            <div className="space-y-3 py-1">
              ...
              <p className="text-sm text-muted-foreground">
                This approves the engineer's resolution of this critical case. The Module Lead will be notified and can proceed to close it.
              </p>
            </div>
          )}
          <DialogFooter>
