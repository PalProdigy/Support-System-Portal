        ...
        <DialogContent className="max-w-sm">
          ...
          {reopeningCase && (
            <div className="space-y-3 py-1">
              ...
              <p className="text-sm text-muted-foreground">Case will move back to <strong className="text-foreground">In Progress</strong>. The engineer and Module Lead will be notified.</p>
            </div>
          )}
          <DialogFooter>
