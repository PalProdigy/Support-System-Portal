...
export function CreateClientDialog({ open, onOpenChange, prefill }: Props) {
  ...
  const reset = useCallback(() => {
    setStep(0)
    setForm({ company_name: '', contact_person: '', phone: '', email: '', business_context: '', pre_sales_notes: '', solution_ids: [] })
  }, [])
  ...
  const step0Valid = form.company_name && form.contact_person && form.phone && emailValid && form.business_context
